...
variable "frontdoor_profile_name"   { description = "Front Door profile name."            ; type = string }
variable "frontdoor_endpoint_name"  { description = "Front Door endpoint name."           ; type = string }
variable "frontdoor_sku_name"       { description = "Front Door SKU."                     ; type = string ; default = "Standard_AzureFrontDoor" }
